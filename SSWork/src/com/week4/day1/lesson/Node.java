...
/*
Generics allow us to add a placeholder type in our class definition that gets filled in when we create the class

I'd create a Node like this: Node<String> myNode = new Node<String>();

One of the typical placeholders is T, standing for Type
-- another one you may see if E for Element
...
public class Node<T> {
    ...
    public Node(T value) {
        this.value = value;
        //this.next = null; //dont need this, because instance variable "next" is null by default
    }
